...
class ReverseMxApiError(Exception):
...
class ParameterError(ReverseMxApiError):
    pass


class EmptyApiKeyError(ReverseMxApiError):
    pass


class ResponseError(ReverseMxApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(ReverseMxApiError):
...
class HttpApiError(ReverseMxApiError):
    pass
